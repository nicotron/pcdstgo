...
public class pcdWorkshop extends PApplet {
...
//      // función que crea el tamaño de la ventana
//
//
// }
//
...
public void draw() {
    ...
    for (int i = 0; i < 10; i ++) {
        ...
        stroke(rojo);
        strokeWeight(5);
        x = map(i, 0, 10, width*.3f, width*.6f);
...
*/
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "pcdWorkshop" };
    if (passedArgs != null) {
